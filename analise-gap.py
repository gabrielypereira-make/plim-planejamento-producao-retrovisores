...
for gap_da_vez in GAPS_PARA_TESTAR:
    print(f"\n>>> EXECUTANDO CENÁRIO: GAP {gap_da_vez:.2f}")
...
# 3. DADOS DE SAÍDA
# ============================================================
pd.DataFrame(log_banco_dados).to_excel("analise_gap.xlsx", index=False)
print("-" * 70)
print(f"✔ Sucesso! Arquivo 'analise_gap.xlsx' gerado com dados de setup.")
